...
public class SUM {
    ...
    /*
     ...
     1. The record matches the POSIX ERE '^[abBcdefghkKnNpPrRqQw 0-9/-]+$'.
     This defines the set of acceptable characters in any FEN record.
     2. Matches the POSIX ERE '^[^ ]+ [^ ]+ [^ ]+ [^ ]+ [^ ]+ [^ ]+$', i.e.,
     a string with six fields separated by single spaces.

     The ordinal number of the tests corresponds to the integer value
